...
2. Copy the AMI to your account
   ...
   **Restore image**
    ...
    - Take note of that AMI ID the script just output. Copy the AMI to `us-east-2` and `us-west-1`:
        - `aws ec2 copy-image --source-image-id ami-0c5c4fca054234f63 --source-region us-east-1 --region us-east-2 --name "udacity-tf-trevor01-east1"`
        - `aws ec2 copy-image --source-image-id ami-0c5c4fca054234f63 --source-region us-east-1 --region us-west-1 --name "udacity-tf-trevor01-east1"`
        - `aws ec2 copy-image --source-image-id ami-0118ac1a3c3485f6c --source-region us-east-1 --region us-east-2 --name "udacity-03-tf-trevor-east1"`
        - `aws ec2 copy-image --source-image-id ami-0118ac1a3c3485f6c --source-region us-east-1 --region us-west-1 --name "udacity-03-tf-trevor-east1"`
